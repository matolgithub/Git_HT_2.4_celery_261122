...
app.config['BROKER_REDIS'] = environ.get('BROKER_REDIS')
app.config['BACKEND_REDIS'] = environ.get('BACKEND_REDIS')

# Initialize extensions
mail = Mail(app)

# Initialize Celery
celery = Celery(app.name, broker=app.config['BROKER_REDIS'])
